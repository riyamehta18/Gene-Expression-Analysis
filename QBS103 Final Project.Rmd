...
```{r}
#chosen gene: BPI - bactericidal permeability increasing protein - a gene that encodes a lipopolysaccharide binding protein and helps with regulating inflammatory responses and defending against bacteria.
